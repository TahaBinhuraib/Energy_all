...
#featureColumns:
f_columns = ['weekDay' , 'weekOfYear' , 'hourOfDay' , 'dayOfMonth' , 'KARAPINAR_Windy' ,'KIVANC_Windy','TEKSIN_Windy','CINGILLI_Windy','BUYUKALAN_Windy','Balikesir_Windy','Gokcedag_Windy','Dinar_Windy','Ucpinar_Windy','Geycek_Windy','TenPrev','ElevenPrev']
